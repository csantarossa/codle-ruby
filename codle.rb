...
def codle(random_word)
    ...
    while (current_guess != max_guesses)
        ...
        puts colored_center("-----------------------------------------------")
        puts colored_center("Correct Placement: " + clue.to_s, 32)
        puts colored_center("-----------------------------------------------")
        puts colored_center("Correct Letters: " + good_characters.to_a.to_s, 33)
        puts colored_center("-----------------------------------------------")
        puts colored_center("Incorrect Letters: " + bad_characters.to_a.to_s)
        puts colored_center("-----------------------------------------------")
